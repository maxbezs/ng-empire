const PaymentsList = () => {
  return (
    <ul
      ...
      className="mx-auto flex w-fit flex-wrap gap-2 px-8 py-4 sm:px-0"
    >
      <li>
        <svg
          role="img"
      ...
      <li>
        <svg role="img" viewBox="0 0 38 24" width="38" height="24" aria-labelledby="pi-google_pay">
      ...
      <li>
        <svg viewBox="0 0 38 24" width="38" height="24" role="img" aria-labelledby="pi-maestro">
      ...
      <li>
        <svg role="img" viewBox="0 0 38 24" width="38" height="24" aria-labelledby="pi-shopify_pay">
      ...
      <li>
        <svg viewBox="-36 25 38 24" width="38" height="24" role="img" aria-labelledby="pi-unionpay">
